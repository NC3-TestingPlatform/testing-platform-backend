...
_TASK_EMAIL = UUID("019ee1a0-7035-7b4b-c6da-bf48ccf5d3c4")
_TASK_PQC = UUID("019ee1a0-8146-7c5c-d7eb-c059ddf6e4d5")
_TASK_DNSSEC = UUID("019ee1a0-9257-7d6d-e8fc-d16aeef7f5e6")

_RESULT_HEADERS = UUID("019ee1a1-0368-7e7e-f90d-e27bfff806f7")
_RESULT_EMAIL = UUID("019ee1a1-1479-7f8f-0a1e-f38c001917a8")
_PRIOR_RESULT_EMAIL = UUID("019ec3b2-58a1-7c40-9e12-7ab34cd56e89")

_FINDING_HSTS = UUID("019ee1a1-258a-7a90-1b2f-049d112a28b9")
_FINDING_DMARC = UUID("019ee1a1-369b-7ba1-2c30-15ae223b39ca")
_FINDING_SPF = UUID("019ee1a1-47ac-7cb2-3d41-26bf334c4adb")
...
_FILE_TASK_METADATA = UUID("019ee1a2-7f93-7ab4-c156-8de74fa9ac23")
_FILE_TASK_MIME = UUID("019ee1a2-80a4-7bc5-d267-9ef85fabbd34")
